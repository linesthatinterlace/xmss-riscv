...
| Binary | What it tests |
|--------|--------------|
| `test_xmss_mt_kat` | XMSS-MT KAT: cross-validation against xmss-reference for 4 h=20 parameter sets (SHA-2 and SHAKE, d=2 and d=4); signs at idx=4 after 4 dummy signs; fingerprint comparison |
